...
// Typography for Al-Fatih Quran App
val AlFatihTypography = Typography(
    // Display styles
...
// Custom Typography for Arabic Text
object ArabicTypography {
    val arabic = TextStyle(
        fontFamily = FontFamily.Default, // Replace with Arabic font when added
        fontWeight = FontWeight.Normal,
        fontSize = 28.sp,
        lineHeight = 48.sp,
        letterSpacing = 0.sp
